...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2024 at 04:33 PM
...
(27, 'Test', 'ttt', '213213132231', NULL, NULL);
...
(8, '2024_03_12_202102_create_comments_table', 4),
(9, '2024_03_19_085600_create_comments_table', 5),
(10, '2024_03_19_142537_create_comments_table', 6);
...
(2, 'user1', 'user1@gmail.com', NULL, '$2y$12$6jh7zUiiKPq8Wd1T9fYPLe3ko7K2enaBQXz0XBlgqH/yvVPdPraeO', NULL, '2024-03-10 09:09:09', '2024-03-10 09:09:09');
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_bid_foreign` FOREIGN KEY (`bid`) REFERENCES `boards` (`id`),
  ADD CONSTRAINT `comments_uid_foreign` FOREIGN KEY (`uid`) REFERENCES `users` (`id`);
COMMIT;
